Функция СведенияОВнешнейОбработке() Экспорт
	...
	ПараметрыРегистрации.Вставить("Наименование", "1с_TreeSHEM построитель схем деревьев"); //имя под которым обработка будет зарегестрирована в справочнике внешних обработок
	...
	НовСтрока.Идентификатор = "1с_TreeSHEM построитель схем деревьев";
	НовСтрока.Использование = "ОткрытиеФормы";
	НовСтрока.Представление = "1с_TreeSHEM построитель схем деревьев";
